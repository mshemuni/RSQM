...
if is_ups_up:
    ...
    if start_jd < now_jd < end_jd:
        ...
        #Get average mesurments for number_of_samples_for_mean samples
    ...
    #Log a line about bad UPS condition
    logger.log("Bad UPS condition {}".format(now_jd))